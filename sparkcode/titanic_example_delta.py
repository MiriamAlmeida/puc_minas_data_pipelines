...
df.write.format("delta").mode("overwrite").save("s3://miriam-341567884088/silver/")
...
old = DeltaTable.forPath(spark, "s3://miriam-341567884088/silver/")
...
(
    ...
    .load("s3://miriam-341567884088/silver/")
