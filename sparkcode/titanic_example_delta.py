...
df = spark.read.csv(
    "s3://miriam-341567884088/titanic", 
    header=True, schema=schema, sep=";"
)

print("Writing titanic dataset as a delta table...")
df.write.format("delta").mode("overwrite").save("s3://dl-processing-zone-341567884088/silver/titanic_delta")
...
old = DeltaTable.forPath(spark, "s3://dl-processing-zone-341567884088/silver/titanic_delta")
...
(
    ...
    .load("s3://dl-processing-zone-341567884088/silver/titanic_delta")
